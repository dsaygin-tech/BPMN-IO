...
export const APP_UI = {
  en: {
    ...
    'toolbar.exportAnimation.title': 'Export token simulation as animated PNG or WebM',
    ...
    'recording.format.png': 'PNG — animated image',
    'recording.format.webm': 'WebM — video',
    ...
    'export.png': 'PNG',
    'export.pdf': 'PDF',
    'export.simulationPng': 'Simulation PNG (animated)',
  ...
  ru: {
    ...
    'toolbar.exportAnimation.title': 'Экспорт симуляции в анимированный PNG или WebM',
    ...
    'recording.format': 'Формат',
    'recording.format.png': 'PNG — анимированное изображение',
    'recording.format.webm': 'WebM — видео',
    ...
    'export.png': 'PNG',
    'export.pdf': 'PDF',
    'export.simulationPng': 'PNG симуляции (анимация)',
